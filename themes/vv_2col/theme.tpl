...
{STYLE}
<!--[if lt IE 7]>
  <link rel="stylesheet" type="text/css" href="{THEME_HTTP}themes/vv_2col/hacks.css" />
<![endif]-->
<!--[if IE 7]>
  <link rel="stylesheet" type="text/css" href="{THEME_HTTP}themes/vv_2col/ie7.css" />
<![endif]-->
...
<div id="mast">
    ...
    <a href="./"><img src="{THEME_HTTP}themes/vv_2col/img/logo.gif" alt="Logo Mast Image" width="500" height="100" border="0" /></a>
</div>
<!-- Mast end -->
