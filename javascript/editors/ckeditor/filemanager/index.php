<?php
session_name(md5($_GET['sh'] . $_SERVER['REMOTE_ADDR']));
session_start();
$image_directory = $_SESSION['ckeditor_image_directory'];
$sh = $_GET['sh'];
echo
<<<EOF
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<script type="text/javascript">var fileRoot = '$image_directory';var sh = '$sh';</script>
