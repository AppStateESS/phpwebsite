...
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=' + encodeURIComponent( FCKConfig.BasePath + 'filemanager/connectors/phpws/connector.php?local=$local') ;
...
var _FileBrowserLanguage	= 'phpws' ;
var _QuickUploadLanguage	= 'phpws' ;
EOF;
?>