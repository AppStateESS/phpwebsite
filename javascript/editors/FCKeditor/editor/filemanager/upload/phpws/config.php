...
$image_path = str_replace('javascript/editors/FCKeditor/editor/filemanager/upload/phpws/upload.php', '', $_SERVER['SCRIPT_NAME']) . 'images/';
if (!empty($_GET['module'])) {
    $image_path .= $_GET['module'] . '/';
 }

$Config['UserFilesPath'] = $image_path;
