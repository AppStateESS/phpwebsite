--TEST--
XMLRPCext Backend XML-RPC cachedServer Validator1 test (easyStructTest with cache on by default 2)
--FILE--
<?php
class TestServer {
    /**
...
CACHE DEBUG : phpdoc comments => weCache=false, lifetime=60
