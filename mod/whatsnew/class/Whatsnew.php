...
class Whatsnew {
        ...
        switch($_REQUEST['aop']) {
            ...
            case 'post_settings':
                ...
                if ($this->postSettings()) {
                    ...
                    \phpws\PHPWS_Core::reroute('index.php?module=whatsnew&aop=menu');
                } else {
                    $this->loadForm('settings');
                }
                break;
    ...
    function loadMessage()
    {
        if (isset($_SESSION['Whatsnew_Message'])) {
            ...
            \phpws\PHPWS_Core::killSession('Whatsnew_Message');
        }
    }
    ...
    {
        \phpws\PHPWS_Core::initModClass('whatsnew', 'Whatsnew_Forms.php');
    ...
    function getKeyMods($match=null, $select_name='exclude', $multiple=true, $count=true)
    {
        ...
        \phpws\PHPWS_Core::initCoreClass('Key.php');
