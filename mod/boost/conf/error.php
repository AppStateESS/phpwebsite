 ...
 */
$errors[BOOST_ERR_NOT_MODULE] = dgettext('boost',
...
$errors[BOOST_FAILED_PRE94_UPGRADE] = dgettext('boost',
        'Failed upgrade of module.');
$errors[BOOST_NO_REGISTER_FILE] = dgettext('boost',
        'Module is missing register file.');
$errors[BOOST_NO_REGISTER_FUNCTION] = dgettext('boost',
        'Module is missing register function.');
$errors[BOOST_FAILED_BACKUP] = dgettext('boost',
