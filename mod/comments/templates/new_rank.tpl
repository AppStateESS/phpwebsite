...
<table id="editrank_{RANK_ID}"
    style="margin-left: 5%; border: 1px solid rgb(144, 238, 144); padding: 5px; text-align: left; width: 95%"
...
>
    <tbody>
        ...
        <tr>
            ...
            <td><span class="smaller">{RANK_IMAGE_HELP}<br />
            </span> {RANK_IMAGE}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{RANK_STACK_1_LABEL}{RANK_STACK_1}
            {RANK_STACK_2_LABEL}{RANK_STACK_2}</td>
        </tr>
    </tbody>
</table>
<!-- END add_new_rank -->
