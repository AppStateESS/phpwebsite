...
// END FUNC PHAT_FormManager
    ...
    function menu()
    {
        ...
        if (PHAT_WARNING && !isset($_SESSION['phatform_warning'])) {
            $_SESSION['phatform_warning'] = true;
            $tags['WARNING'] = '<div class="alert alert-danger">Please transfer your forms to an alternate system. Form Generator is being phased out.</div>';
        }
