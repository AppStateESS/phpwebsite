...
class PHAT_Report {
    ...
    function formStats() {
        ...
        $statsTags['INCOMPLETE_LABEL'] = 'Incomplete';
        $statsTags['INCOMPLETE_NUM'] = $this->_incompleteEntries;
        $statsTags['TOTAL_LABEL'] = 'Total';
        $statsTags['TOTAL_NUM'] = $this->_totalEntries;

        $statsTags['LAST_ENTRY_LABEL'] = 'Last Entry';
        $statsTags['LAST_ENTRY'] = $this->getLastEntry();

        $statsTags['LIST_LINK'] = '<a href="index.php?module=phatform&amp;PHAT_REPORT_OP=list&amp;PHAT_FullList=1">' . 'Full List' . '</a>';
    ...
    function listEntries() {
        ...
        $listTags = array();
        $listTags['ID_LABEL'] = 'ID';
        $listTags['USER_LABEL'] = 'User';
        $listTags['UPDATED_LABEL'] = 'Updated';
