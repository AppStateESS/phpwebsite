...
class Sitemap_Forms {
    ...
    public function mapSetup()
    {
        ...
        if (@$_REQUEST['exclude_keys']) {
            ...
            $kMatch = unserialize(core\Settings::get('sitemap', 'exclude_keys'));
        }
        ...
        $form->setMatch('addkeys', \core\Settings::get('sitemap', 'addkeys'));
        ...
        $this->sitemap->content = \core\Template::process($tpl, 'sitemap', 'map_settings.tpl');
    }
    ...
    public function editSettings()
    {
        ...
        $form->addText('cache_timeout', \core\Settings::get('sitemap', 'cache_timeout'));
        ...
        $tpl['KEY_SELECT'] = $this->sitemap->getKeyMods(unserialize(core\Settings::get('sitemap', 'exclude_keys')), 'exclude_keys');
        ...
        $this->sitemap->content = \core\Template::process($tpl, 'sitemap', 'edit_settings.tpl');
    }
    ...
    public function showInfo()
    {
        ...
        $this->sitemap->content = \core\Template::process($tpl, 'sitemap', 'info.tpl');
    }
