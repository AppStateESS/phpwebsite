...
abstract class FC_Folder_Factory
{
    ...
    public function printFolderList()
    {
        ...
        foreach ($this->folders as $folder) {
            ...
            $lines[] = "<li class='folder $active_class' data-ftype='$this->ftype' data-folder-id='$id'><a data-folder-id='$id' class='edit-folder'><i class='pull-right fa fa-edit fa-lg admin'></i></a> $title</li>";
        }
        return implode("\n", $lines);
    }
