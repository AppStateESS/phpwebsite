<table border="0" cellpadding="0" align="left">
    ...
    <tr>
        ...
        >
            ...
            <param name="console" value="video">
            <EMBED src="http://servername/path/to/media.file"
                width="{WIDTH}" height="30" controls="ControlPanel"
    ...
    <tr>
        <td align="center"><a
            href="http://servername/path/to/media.file"
            style="font-size: 85%;" target="_blank"
        >Launch in external player</a> <!-- ...end link to launch external media player... -->
        </td>
    </tr>
</table>
