...
<div id="player{ID}"><a href="http://www.macromedia.com/go/getflashplayer">Get the Flash Player</a> to see this player.</div>

<script type="text/javascript">
var so = new SWFObject('templates/filecabinet/filters/media/mediaplayer.swf','mpl','{WIDTH}','{HEIGHT}','8');
