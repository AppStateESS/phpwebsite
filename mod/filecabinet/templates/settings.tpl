{START_FORM}
<fieldset><legend><strong>{DOCUMENT_SETTINGS}</strong></legend>
<p><strong>{BASE_DOC_DIRECTORY_LABEL}</strong><br />
...
<p><strong>{MAX_THUMBNAIL_SIZE_LABEL}</strong> {MAX_THUMBNAIL_SIZE}</p>
...
<p><strong>{NUMBER_VISIBLE_LABEL}</strong> {NUMBER_VISIBLE}</p>
</fieldset>
</fieldset>
<fieldset><legend><strong>{FCK_SETTINGS}</strong></legend>
...
<fieldset><legend><strong>{CLASSIFY_SETTINGS}</strong></legend>
<p><strong>{CLASSIFY_DIRECTORY_LABEL}</strong><br />
{CLASSIFY_DIRECTORY}</p>
</fieldset>
<!-- END classify-settings -->
<fieldset><legend><strong>{SYSTEM_SIZE}</strong></legend>
