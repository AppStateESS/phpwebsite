...
$errors[FC_IMG_SIZE]               = dgettext('filecabinet', 'Image was %sK making it larger than %sK size limit.');
...
$errors[FC_DOCUMENT_SIZE]          = dgettext('filecabinet', 'Document was %sK making it larger than %sK size limit.');
