...
Deprecate::moduleWarning('vshop');

PHPWS_Core::initModClass('vshop', 'vShop.php');
$vshop = new vShop;
...
if (isset($_REQUEST['aop'])) {
    ...
    $vshop->userMenu();
} elseif (isset($_REQUEST['id']) && isset($_REQUEST['item_id'])) {
    $vshop->userMenu('view_item');
} elseif (isset($_REQUEST['id'])) {
    $vshop->userMenu('view_dept');
} elseif (isset($_REQUEST['dept']) && isset($_REQUEST['item'])) {
    $vshop->userMenu('view_item');
