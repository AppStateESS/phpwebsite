...
<table cellpadding="4" cellspacing="1" width="98%">
    <tr style="vertical-align: top">
        ...
        <th>{CREATE_DATE_SORT} {CREATE_DATE_LABEL}
        {CREATED_NAME_SORT} {NAME_LABEL} <br />
        {UPDATE_DATE_SORT} {UPDATE_DATE_LABEL} {UPDATED_NAME_SORT}
        {NAME_LABEL}</th>
    ...
    <tr{TOGGLE}>
        <td>{TITLE}</td>
        <td class="smaller">{CREATE_DATE} {CREATED_NAME}<br />
        {UPDATE_DATE} {UPDATED_NAME}</td>
        <td>{ACTIVE}</td>
        <td>{ACTION}</td>
    </tr>
    <!-- END listrows -->
