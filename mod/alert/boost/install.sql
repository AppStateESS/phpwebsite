...
prt_id INT UNSIGNED NOT NULL default 0 ,
...
updated_by_id INT UNSIGNED NOT NULL default 0,
updated_name varchar(50) not null,
type_id INT UNSIGNED NOT NULL default 0,
contact_complete INT UNSIGNED NOT NULL default 0,
...
post_type SMALLINT UNSIGNED NOT NULL default 0 ,
