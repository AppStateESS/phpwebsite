...
<table width="99%" cellpadding="4">
    ...
    <tr{TOGGLE}>
        <td colspan="{COLSPAN}" class="smaller"><!-- BEGIN thumb -->
        <div style="float: left; margin: 0 .5em .2em 0;">{THUMB}</div>
        <!-- END thumb --> {DESCRIPTION} <!-- BEGIN group_links -->
        <div>{GROUP_LINKS_LABEL}: <b>{GROUP_LINKS}</b></div>
        <!-- END group_links --> <!-- BEGIN file -->
        <div>{FILE_LABEL}: {FILE}</div>
        <!-- END file --></td>
    </tr>
    <!-- END listrows -->
</table>
