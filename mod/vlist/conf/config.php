...
//define('VLIST_DATE_FORMAT', '%T, %A, %B %e');
define('VLIST_DATE_FORMAT', '%H:%M, %a, %b %e');


/* Set default rows and columns for textareas */
define('UNI_DEFAULT_ROWS', 5);
define('UNI_DEFAULT_COLS', 40);

/* Set default size and maxsize for textfields */
define('UNI_DEFAULT_SIZE', 33);
define('UNI_DEFAULT_MAXSIZE', 255);
