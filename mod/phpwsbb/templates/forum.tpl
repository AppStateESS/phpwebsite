...
<table class="box phpwsbb" cellspacing="1" cellpadding="6">
    <tr class="box-title">
        ...
        <!-- END VIEWS_LABEL -->
        <th valign="middle"
            style="text-align: center; white-space: nowrap; min-width: 20%"
            scope="col"
    ...
    <tr{TOGGLE}>
        ...
        <td>{THREAD_TITLE_LINK} <br />
        <span style="float: right;"> {TOPIC_STICKY}
        {TOPIC_LOCKED} {TOPIC_IS_HOT} <!-- BEGIN PGLNKS --><span
            class="phpwsbb_pagelist smaller"
        >({THREAD_PAGES})</span><!-- END PGLNKS --> </span> <span class="smaller">{THREAD_AUTHOR}</span>
        </td>
...
<!-- BEGIN navigate -->
<div>
<div class="align-center" style="float: right;">{TOTAL_ROWS}<br />
{PAGE_LABEL} {PAGES}<br />
{LIMIT_LABEL} {LIMITS}<br />
</div>
<br />
{FORUM_ADD_TOPIC_BTN}</div>
<!-- END navigate -->
<br />
<br />
<br />
