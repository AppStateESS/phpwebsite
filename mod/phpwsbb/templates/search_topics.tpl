...
<!-- END VIEWS_LABEL -->
    ...
    <th valign="middle" nowrap="nowrap" style="text-align:center" scope="col">{PHPWSBB_FORUMS_TITLE_SORT}</th>
</tr>
...
<!-- END VIEWS -->
    <td class="smaller" style="text-align:left; margin-right:2em; width:20%; white-space:nowrap">{THREAD_LASTPOST_INFO}</td>
