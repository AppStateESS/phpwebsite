...
<!-- BEGIN listrows -->
<div class="comments">
<table id="cm_{COMMENT_ID}" class="comment-table{TOGGLE}"
    style="width: 100%"
>
    <tr>
        <td colspan="2" class="comment-header bgcolor3">
        <div style="float: right">{FORUM_LBL}: {FORUM_LINK}</div>
        <div style="padding-top: .25em;">{CREATE_TIME}</div>
        </td>
        <tr>
            ...
            <div class="smaller">{CREATE_TIME}<br />
