...
class PHPWSBB_Forum
{
    ...
    public function view ()
    {
        ...
        $pager->joinResult('key_id', 'phpws_key', 'id', 'title');
        $pager->joinResult('key_id', 'phpws_key', 'id', 'creator');
        $pager->joinResult('key_id', 'phpws_key', 'id', 'times_viewed');
        $pager->addSortHeader('title', dgettext('phpwsbb', 'Topic'));
        $pager->addSortHeader('creator', dgettext('phpwsbb', 'Topic Starter'));
        $pager->addSortHeader('create_date', dgettext('phpwsbb', 'Start Date'));
