 ...
 *
 * @version $Id: Template.php 7931 2011-02-07 20:46:17Z matt $
...
class PHPWS_Template extends HTML_Template_Sigma {
    ...
    {
        if ($module == 'core') {
            return 'Backward/Templates/';
        }

        return "mod/$module/templates/";
    }
    ...
    public function setFile($file, $strict = false)
    {
        ...
        if ($strict == true) {
            ...
            $mod_tpl = "mod/$module/templates/$file";

            if (is_file($mod_tpl)) {
                $result = $this->loadTemplateFile($mod_tpl);
                $used_tpl = & $mod_tpl;
            } else {
                throw new Exception(t('Missing template file: %s', $mod_tpl));
            }
        }
